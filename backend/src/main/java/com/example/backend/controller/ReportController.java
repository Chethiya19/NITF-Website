...
public class ReportController {
    ...
    @GetMapping("/rep-count")
    public ResponseEntity<Long> getReportCountForLoggedInMember(@AuthenticationPrincipal UserDetails userDetails) {
        String memberNic = userDetails.getUsername();
        long count = reportService.getReportCountByMemberNic(memberNic);
